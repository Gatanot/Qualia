...
import { AgentLoop, AgentLogger } from '../agent/index.js';
import type { BuildResult } from '../agent/index.js';
...
If an operation requires confirmation, skip it and explain why.`;
			...
			const session = await storage.createSession(undefined, task.workspace || process.cwd());
