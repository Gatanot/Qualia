...
import type { ProviderConfig, AppConfig } from '@gatanot/qualia_core/config';
import { EmailAdapter } from '@gatanot/qualia_core/gateway';
import type { EmailConfig } from '@gatanot/qualia_core/gateway';
