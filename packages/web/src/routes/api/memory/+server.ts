...
import type { Memory, MemoryType, MemoryStatus, MemorySourceKind } from '@gatanot/qualia_core/memory';
...
function sanitizeImport(raw: unknown): Memory | null {
	...
	return {
		...
		source_message_id: typeof r.source_message_id === 'string' ? r.source_message_id : null,
